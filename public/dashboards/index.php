<?php
$GLOBALS['current_dashboard'] = 'index';
require_once('../../dashboards/_init.php');
          ...
          <?=$topbar?>
            ...
            <div class="row border-bottom white-bg dashboard-header ">
                ...
                <div class="col-xl-6">
                    ...
                    <span class="text-muted">Click on Dashboards on the left to choose a tool.</span>
            ...
            <div class="footer">
              <!--  <div class="float-end">
                ...
                <div>
                    ...
                    2014 -
                    <script>document.write(new Date().getFullYear())</script> <a href="https://wrapbootstrap.com/theme/inspinia-responsive-admin-template-WB0R5L90S?ref=inspinia" target="_blank">Inspinia</a> By <span class="fw-bold">WebAppLayers</span>
                </div> -->
            </div>
